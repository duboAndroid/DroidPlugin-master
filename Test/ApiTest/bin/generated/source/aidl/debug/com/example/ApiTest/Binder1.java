 ...
 * Original file: C:\\Users\\dubo\\Desktop\\demo\\DroidPlugin-master\\Test\\ApiTest\\src\\com\\example\\ApiTest\\Binder1.aidl
 */
package com.example.ApiTest;
/**
 * Created by zhangyong6 on 2016/1/25.
 */
public interface Binder1 extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.example.ApiTest.Binder1
{
private static final java.lang.String DESCRIPTOR = "com.example.ApiTest.Binder1";
...
/**
 * Cast an IBinder object into an com.example.ApiTest.Binder1 interface,
 * generating a proxy if needed.
 */
public static com.example.ApiTest.Binder1 asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.example.ApiTest.Binder1))) {
return ((com.example.ApiTest.Binder1)iin);
}
return new com.example.ApiTest.Binder1.Stub.Proxy(obj);
}
...
private static class Proxy implements com.example.ApiTest.Binder1
{
